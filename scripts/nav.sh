...
cmds=("ros2 launch depthai_examples stereo_inertial_node.launch.py"
	...
	"ros2 run loop_fusion loop_fusion_node /home/tup/ros2_ws/src/TUP2023-Sentry-Framework/TUP2023-Sentry-Nav/VINS-Fusion-ROS2/config/oak-d-pro-400p/oak-rectfied-load-pose.yaml"
